...
import CheckyRequestButton from "./components/CheckyRequestButton";
...
export default function DragGPT() {
  ...
  const [state, send] = useMachine(dragStateMachine, {
    actions: {
      setPositionOnScreen: (context: any) => {
  ...
  useEffect(() => {
    const onContextMenu = (event: MouseEvent) => {
      // TODO: context menu가 뜨는 위치에 따라서 request button의 위치를 조정해야 한다.
    };
