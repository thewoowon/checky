...
const checkyChatStateMachine = createMachine(
  {
    id: "checky-chat-state",
    initial: "init",
    ...
    tsTypes: {} as import("./checkyChatStateMachine.typegen").Typegen0,
    states: {
      init: {
        invoke: {
...
export default checkyChatStateMachine;
